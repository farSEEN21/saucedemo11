...
public class tets extends TestBase{}
//    WebDriver wd ;
// //  ConfigWeb cw=new ConfigWeb();
//   Methods metr=new Methods();
//
//    @BeforeTest
//    public void start() {
//
...
//        metr.type(By.xpath("//input[@id='user-name']"), arr[0] + "_user");
//        metr.type(By.xpath("//input[@id='password']"), "secret_sauce");
//        metr.click(By.xpath("//input[@id='login-button']"));
//        metr.click(By.xpath("//button[@id='add-to-cart-sauce-labs-backpack']"));
//        metr.click(By.xpath("//a[@class='shopping_cart_link']"));
//        metr.click(By.xpath("//button[@id='checkout']"));
//        metr.type(By.xpath("//input[@id='first-name']"), "Aleks");
//        metr.type(By.xpath("//input[@id='last-name']"), "Brown");
//        metr.type(By.xpath("//input[@id='postal-code']"), "324324234");
//        metr.click(By.xpath("//input[@id='continue']"));
//        metr.click(By.xpath("//button[@id='finish']"));
...
//        String[] arr = GetUserName();
//        metr.type(By.xpath("//input[@id='user-name']"), arr[1] + "_user");
//        metr.type(By.xpath("//input[@id='password']"), "secret_sauce");
//        metr.click(By.xpath("//input[@id='login-button']"));
//
//    }
...
//        CorrectLogin();
//        metr.click(By.xpath("//div[@id='shopping_cart_container']"));
...
//        HelperBase methods=new HelperBase();
//        methods.clicks(By.xpath("//button[@id='add-to-cart-sauce-labs-backpack']"));
//        CorrectLogin();
//        metr.click(By.xpath("//button[@id='add-to-cart-sauce-labs-backpack']"));
//        metr.click(By.xpath("//div[@id='shopping_cart_container']"));
